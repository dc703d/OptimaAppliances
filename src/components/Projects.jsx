...
const Projects = () => {
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Services'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam ad magnam aliquam quas repudiandae in rem accusamus facilis, nesciunt labore ipsa consectetur fugiat. Veniam commodi in velit possimus voluptates porro.</p>
