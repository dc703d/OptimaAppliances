...
const About = () => {
  return (
    <div className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
      ...
      <p className='text-gray-500 max-w-80 text-center mb-8'>Passionate About Appliances, Dedicated to Your Vision</p>
        <div className='flex flex-col md:flex-row items-center md: items-start md:gap-20'>
            <img src={assets.kitchen} alt='brand image' className='w-full sm:w-1/2 max-w-lg'/>
